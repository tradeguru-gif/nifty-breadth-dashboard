...
# --------------------------------------------------
# USER: Replace these with your actual active CE and PE Security IDs
# (Nearest monthly expiry, ATM strike)
# --------------------------------------------------
CE_ID = "63719"   # <-- CHANGE
PE_ID = "63720"   # <-- CHANGE

# --------------------------------------------------
# Global market data state (for WordPress)
# --------------------------------------------------
latest_data = {
    "signal": "WAITING",
    "ce_price": 0.0,
...
# --------------------------------------------------
# Technical Indicators (all functions defined)
# --------------------------------------------------
