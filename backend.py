# === HYBRID v17.9 – FIXED MARKET HOURS & CANDLE BUILDING ===
# - Fixed: Market hours logic for MCX (open until 23:30)
# - Fixed: Candle building for both equity and MCX
# - Fixed: has_complete_data() for commodities
# - Fixed: Volume tracking for REST fallback
# - Fixed: Signal generation for equity indices
# - Restored: Full signal engine with ADX confirmation
...
def is_mcx_open():
    ...
    close_time = dt_time(23, 30)  # MCX closes at 11:30 PM
...
# ----------------------------------------------------------------------
# has_complete_data() - FIXED for commodities
# ----------------------------------------------------------------------
...
def home():
    return jsonify({
        "status": "healthy",
        "engine": "Hybrid v17.9 – Fixed Market Hours & Candle Building",
