...
# --------------------------------------------------
# OPTION SECURITY IDS
# Replace with your ACTIVE CE/PE security IDs
# --------------------------------------------------
CE_ID = "63719"
PE_ID = "63720"
...
async def websocket_loop():
    while True:
        try:
            ...
            print(f"✅ Subscribing to CE={CE_ID}, PE={PE_ID}")

            await feed.connect()
            await feed.subscribe_instruments()

            print("✅ Feed connected successfully")
