...
# Features: multi‑timeframe, anti‑flip, auto contract rollover, REST fallback,
#           queue processing, volume tracking, dynamic thresholds, watchdog,
#           pre‑auth timer, graceful shutdown, metrics endpoint.
...
# ------------------------------------------------------------
# Technical Indicators (unchanged but robust)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Core Signal Engine (professional scoring)
# ------------------------------------------------------------
