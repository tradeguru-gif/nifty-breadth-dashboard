...
# --------------------------------------------------
# Environment variables (Angel One credentials)
# --------------------------------------------------
...
def home():
    return jsonify({
        "status": "online", 
        "message": "Nifty Signal Engine v5.1 Ultimate (Live WebSocket)",
...
# Start the WebSocket engine immediately when the app loads
